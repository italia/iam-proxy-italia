# How to run the Demo Django template
 ...
 Within the directory `/{your path}/iam-proxy-italia/iam-proxy-italia-project-demo-examples` execute the following commands
...
You will be redirect to the Saml2 Service Provider page [Service Provider page](project-configuration.md)
