...
This container work as [uWSGI](https://en.wikipedia.org/wiki/UWSGI) proxy to the [iam-proxy-italia composition](docker-compose.md) and serve static file like the discovery page.
