...
Use this demo to test login against the **satosa-oidcop** frontend. The client is pre-registered in MongoDB (see [README.mongo.md](../../README.mongo.md) and [Docker-compose/mongo/init-mongo.sh](../../Docker-compose/mongo/init-mongo.sh)).
