...
- **Internal links**: Verify that links to other docs (e.g. `README-Setup.md`, `docs/TROUBLESHOOTING.md`) point to existing files and that anchor fragments (e.g. `#configuration-by-environment-variables`) match the target headings (GitHub-style anchors are lowercase with hyphens).
